...
pacstrap -K /mnt base linux linux-headers linux-lts linux-lts-headers linux-firmware sudo nano grub efibootmgr gnome networkmanager pipewire git zsh timeshift mesa libva-mesa-driver vulkan-radeon xorg-server grub-btrfs inotify-tools reflector
